...
class TransportControls(QWidget):
    ...
    instrument_changed = Signal(str)  # Forward from audio status bar
    ...
    def init_ui(self):
        ...
        self.audio_status_bar.instrument_changed.connect(self.instrument_changed.emit)
    ...
    def create_pattern_controls(self):
        ...
        self.pattern_info_label.setStyleSheet(
            "font-size: 10px; color: gray; margin-top: 5px;"
        )
    ...
    def on_pattern_changed(self):
        ...
        if pattern_id and pattern_id in self.patterns:
            ...
            info_text = (
                f"{time_sig_str}, {pattern.steps_per_bar} шагов\n{pattern.notes}"
            )
